...
class SendToUserType {
  ...
  static const unknownDefaultOpenApi = SendToUserType._(r'unknown_default_open_api');
  ...
  SendToUserType? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return SendToUserType.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
