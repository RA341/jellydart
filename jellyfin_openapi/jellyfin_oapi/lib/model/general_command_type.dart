...
class GeneralCommandType {
  ...
  static const unknownDefaultOpenApi = GeneralCommandType._(r'unknown_default_open_api');
  ...
  GeneralCommandType? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return GeneralCommandType.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
