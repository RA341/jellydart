...
class ExternalIdMediaType {
  ...
  static const unknownDefaultOpenApi = ExternalIdMediaType._(r'unknown_default_open_api');
  ...
  ExternalIdMediaType? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return ExternalIdMediaType.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
