...
class MediaProtocol {
  ...
  static const unknownDefaultOpenApi = MediaProtocol._(r'unknown_default_open_api');
  ...
  MediaProtocol? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return MediaProtocol.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
