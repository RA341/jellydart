...
class HeaderMatchType {
  ...
  static const unknownDefaultOpenApi = HeaderMatchType._(r'unknown_default_open_api');
  ...
  HeaderMatchType? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return HeaderMatchType.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
