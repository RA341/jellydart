...
class RemoveFromPlaylistRequestDto {
  ...
  bool operator ==(Object other) => identical(this, other) || other is RemoveFromPlaylistRequestDto &&
    _deepEquality.equals(other.playlistItemIds, playlistItemIds) &&
  ...
  static RemoveFromPlaylistRequestDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return RemoveFromPlaylistRequestDto(
        playlistItemIds: json[r'PlaylistItemIds'] is Iterable
            ? (json[r'PlaylistItemIds'] as Iterable).cast<String>().toList(growable: false)
            : const [],
  ...
  static Map<String, List<RemoveFromPlaylistRequestDto>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = RemoveFromPlaylistRequestDto.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
