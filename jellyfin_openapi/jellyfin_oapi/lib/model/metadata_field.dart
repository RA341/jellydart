...
class MetadataField {
  ...
  static const unknownDefaultOpenApi = MetadataField._(r'unknown_default_open_api');
  ...
  MetadataField? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return MetadataField.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
