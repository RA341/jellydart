...
class GroupStateType {
  ...
  static const unknownDefaultOpenApi = GroupStateType._(r'unknown_default_open_api');
  ...
  GroupStateType? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return GroupStateType.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
