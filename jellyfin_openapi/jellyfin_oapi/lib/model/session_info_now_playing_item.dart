...
class SessionInfoNowPlayingItem {
  ...
  bool operator ==(Object other) => identical(this, other) || other is SessionInfoNowPlayingItem &&
    ...
    _deepEquality.equals(other.externalUrls, externalUrls) &&
    _deepEquality.equals(other.mediaSources, mediaSources) &&
    other.criticRating == criticRating &&
    _deepEquality.equals(other.productionLocations, productionLocations) &&
    other.path == path &&
    ...
    _deepEquality.equals(other.taglines, taglines) &&
    ...
    _deepEquality.equals(other.studios, studios) &&
    _deepEquality.equals(other.genreItems, genreItems) &&
    other.parentLogoItemId == parentLogoItemId &&
    other.parentBackdropItemId == parentBackdropItemId &&
    _deepEquality.equals(other.parentBackdropImageTags, parentBackdropImageTags) &&
    ...
    _deepEquality.equals(other.albumArtists, albumArtists) &&
    other.seasonName == seasonName &&
    _deepEquality.equals(other.mediaStreams, mediaStreams) &&
    other.videoType == videoType &&
    other.partCount == partCount &&
    other.mediaSourceCount == mediaSourceCount &&
    _deepEquality.equals(other.imageTags, imageTags) &&
    _deepEquality.equals(other.backdropImageTags, backdropImageTags) &&
    _deepEquality.equals(other.screenshotImageTags, screenshotImageTags) &&
    ...
    _deepEquality.equals(other.lockedFields, lockedFields) &&
  ...
  static SessionInfoNowPlayingItem? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return SessionInfoNowPlayingItem(
        ...
        dateLastMediaAdded: mapDateTime(json, r'DateLastMediaAdded', r''),
        ...
        externalUrls: ExternalUrl.listFromJson(json[r'ExternalUrls']),
        mediaSources: MediaSourceInfo.listFromJson(json[r'MediaSources']),
        criticRating: mapValueOfType<double>(json, r'CriticRating'),
        productionLocations: json[r'ProductionLocations'] is Iterable
            ? (json[r'ProductionLocations'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        ...
        taglines: json[r'Taglines'] is Iterable
            ? (json[r'Taglines'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        ...
        people: BaseItemPerson.listFromJson(json[r'People']),
        studios: NameGuidPair.listFromJson(json[r'Studios']),
        genreItems: NameGuidPair.listFromJson(json[r'GenreItems']),
        ...
        parentBackdropImageTags: json[r'ParentBackdropImageTags'] is Iterable
            ? (json[r'ParentBackdropImageTags'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        ...
        airDays: DayOfWeek.listFromJson(json[r'AirDays']),
        ...
        artists: json[r'Artists'] is Iterable
            ...
            : const [],
        artistItems: NameGuidPair.listFromJson(json[r'ArtistItems']),
        ...
        albumArtists: NameGuidPair.listFromJson(json[r'AlbumArtists']),
        seasonName: mapValueOfType<String>(json, r'SeasonName'),
        mediaStreams: MediaStream.listFromJson(json[r'MediaStreams']),
        ...
        backdropImageTags: json[r'BackdropImageTags'] is Iterable
            ? (json[r'BackdropImageTags'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        screenshotImageTags: json[r'ScreenshotImageTags'] is Iterable
            ? (json[r'ScreenshotImageTags'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        ...
        chapters: ChapterInfo.listFromJson(json[r'Chapters']),
        ...
        lockedFields: MetadataField.listFromJson(json[r'LockedFields']),
  ...
  static Map<String, List<SessionInfoNowPlayingItem>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = SessionInfoNowPlayingItem.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
