...
class TranscodeReason {
  ...
  static const unknownDefaultOpenApi = TranscodeReason._(r'unknown_default_open_api');
  ...
  TranscodeReason? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return TranscodeReason.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
