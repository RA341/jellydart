...
class GroupUpdateType {
  ...
  static const unknownDefaultOpenApi = GroupUpdateType._(r'unknown_default_open_api');
  ...
  GroupUpdateType? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return GroupUpdateType.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
