...
class MediaSourceInfo {
  ...
  bool operator ==(Object other) => identical(this, other) || other is MediaSourceInfo &&
    ...
    _deepEquality.equals(other.mediaAttachments, mediaAttachments) &&
    _deepEquality.equals(other.formats, formats) &&
    other.bitrate == bitrate &&
    other.timestamp == timestamp &&
    _deepEquality.equals(other.requiredHttpHeaders, requiredHttpHeaders) &&
  ...
  static MediaSourceInfo? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MediaSourceInfo(
        ...
        mediaAttachments: MediaAttachment.listFromJson(json[r'MediaAttachments']),
        formats: json[r'Formats'] is Iterable
            ? (json[r'Formats'] as Iterable).cast<String>().toList(growable: false)
            : const [],
  ...
  static Map<String, List<MediaSourceInfo>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = MediaSourceInfo.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
