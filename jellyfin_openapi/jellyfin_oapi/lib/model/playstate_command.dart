...
class PlaystateCommand {
  ...
  static const unknownDefaultOpenApi = PlaystateCommand._(r'unknown_default_open_api');
  ...
  PlaystateCommand? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return PlaystateCommand.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
