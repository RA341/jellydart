...
class DlnaProfileType {
  ...
  static const unknownDefaultOpenApi = DlnaProfileType._(r'unknown_default_open_api');
  ...
  DlnaProfileType? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return DlnaProfileType.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
