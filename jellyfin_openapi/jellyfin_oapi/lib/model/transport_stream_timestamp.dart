...
class TransportStreamTimestamp {
  ...
  static const unknownDefaultOpenApi = TransportStreamTimestamp._(r'unknown_default_open_api');
  ...
  TransportStreamTimestamp? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return TransportStreamTimestamp.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
