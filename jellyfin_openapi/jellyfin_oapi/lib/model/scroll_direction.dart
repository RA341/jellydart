...
class ScrollDirection {
  ...
  static const unknownDefaultOpenApi = ScrollDirection._(r'unknown_default_open_api');
  ...
  ScrollDirection? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return ScrollDirection.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
