...
class Video3DFormat {
  ...
  static const unknownDefaultOpenApi = Video3DFormat._(r'unknown_default_open_api');
  ...
  Video3DFormat? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return Video3DFormat.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
