...
class CollectionTypeOptions {
  ...
  static const unknownDefaultOpenApi = CollectionTypeOptions._(r'unknown_default_open_api');
  ...
  CollectionTypeOptions? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return CollectionTypeOptions.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
