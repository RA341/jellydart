...
class SystemInfo {
  ...
  bool operator ==(Object other) => identical(this, other) || other is SystemInfo &&
    ...
    _deepEquality.equals(other.completedInstallations, completedInstallations) &&
  ...
  static SystemInfo? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return SystemInfo(
        ...
        completedInstallations: InstallationInfo.listFromJson(json[r'CompletedInstallations']),
