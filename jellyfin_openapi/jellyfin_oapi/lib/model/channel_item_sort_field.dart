...
class ChannelItemSortField {
  ...
  static const unknownDefaultOpenApi = ChannelItemSortField._(r'unknown_default_open_api');
  ...
  ChannelItemSortField? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return ChannelItemSortField.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
