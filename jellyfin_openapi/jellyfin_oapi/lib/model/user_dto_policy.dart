...
class UserDtoPolicy {
  ...
  bool operator ==(Object other) => identical(this, other) || other is UserDtoPolicy &&
    ...
    _deepEquality.equals(other.blockedTags, blockedTags) &&
    other.enableUserPreferenceAccess == enableUserPreferenceAccess &&
    _deepEquality.equals(other.accessSchedules, accessSchedules) &&
    _deepEquality.equals(other.blockUnratedItems, blockUnratedItems) &&
    ...
    _deepEquality.equals(other.enableContentDeletionFromFolders, enableContentDeletionFromFolders) &&
    ...
    _deepEquality.equals(other.enabledDevices, enabledDevices) &&
    other.enableAllDevices == enableAllDevices &&
    _deepEquality.equals(other.enabledChannels, enabledChannels) &&
    other.enableAllChannels == enableAllChannels &&
    _deepEquality.equals(other.enabledFolders, enabledFolders) &&
    ...
    _deepEquality.equals(other.blockedMediaFolders, blockedMediaFolders) &&
    _deepEquality.equals(other.blockedChannels, blockedChannels) &&
  ...
  static UserDtoPolicy? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return UserDtoPolicy(
        ...
        blockedTags: json[r'BlockedTags'] is Iterable
            ? (json[r'BlockedTags'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        enableUserPreferenceAccess: mapValueOfType<bool>(json, r'EnableUserPreferenceAccess'),
        accessSchedules: AccessSchedule.listFromJson(json[r'AccessSchedules']),
        blockUnratedItems: UnratedItem.listFromJson(json[r'BlockUnratedItems']),
        ...
        enableContentDeletionFromFolders: json[r'EnableContentDeletionFromFolders'] is Iterable
            ? (json[r'EnableContentDeletionFromFolders'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        ...
        enabledDevices: json[r'EnabledDevices'] is Iterable
            ? (json[r'EnabledDevices'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        enableAllDevices: mapValueOfType<bool>(json, r'EnableAllDevices'),
        enabledChannels: json[r'EnabledChannels'] is Iterable
            ? (json[r'EnabledChannels'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        enableAllChannels: mapValueOfType<bool>(json, r'EnableAllChannels'),
        enabledFolders: json[r'EnabledFolders'] is Iterable
            ? (json[r'EnabledFolders'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        ...
        blockedMediaFolders: json[r'BlockedMediaFolders'] is Iterable
            ? (json[r'BlockedMediaFolders'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        blockedChannels: json[r'BlockedChannels'] is Iterable
            ? (json[r'BlockedChannels'] as Iterable).cast<String>().toList(growable: false)
            : const [],
  ...
  static Map<String, List<UserDtoPolicy>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = UserDtoPolicy.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
