...
class AlbumInfo {
  ...
  bool operator ==(Object other) => identical(this, other) || other is AlbumInfo &&
    ...
    _deepEquality.equals(other.artistProviderIds, artistProviderIds) &&
    _deepEquality.equals(other.songInfos, songInfos);
  ...
  static AlbumInfo? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return AlbumInfo(
        ...
        albumArtists: json[r'AlbumArtists'] is Iterable
            ? (json[r'AlbumArtists'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        artistProviderIds: mapCastOfType<String, String>(json, r'ArtistProviderIds') ?? const {},
        songInfos: SongInfo.listFromJson(json[r'SongInfos']),
      );
    }
    return null;
  }
  ...
  static Map<String, List<AlbumInfo>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = AlbumInfo.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
