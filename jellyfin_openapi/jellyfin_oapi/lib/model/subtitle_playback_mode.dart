...
class SubtitlePlaybackMode {
  ...
  static const unknownDefaultOpenApi = SubtitlePlaybackMode._(r'unknown_default_open_api');
  ...
  SubtitlePlaybackMode? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return SubtitlePlaybackMode.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
