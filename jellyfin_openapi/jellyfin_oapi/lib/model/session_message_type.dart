...
class SessionMessageType {
  ...
  static const unknownDefaultOpenApi = SessionMessageType._(r'unknown_default_open_api');
  ...
  SessionMessageType? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return SessionMessageType.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
