...
class PinRedeemResult {
  ...
  bool operator ==(Object other) => identical(this, other) || other is PinRedeemResult &&
    ...
    _deepEquality.equals(other.usersReset, usersReset);
  ...
  static PinRedeemResult? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return PinRedeemResult(
        ...
        usersReset: json[r'UsersReset'] is Iterable
            ? (json[r'UsersReset'] as Iterable).cast<String>().toList(growable: false)
            : const [],
      );
    }
    return null;
  ...
  static Map<String, List<PinRedeemResult>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = PinRedeemResult.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
