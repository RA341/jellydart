...
class MediaSourceType {
  ...
  static const unknownDefaultOpenApi = MediaSourceType._(r'unknown_default_open_api');
  ...
  MediaSourceType? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return MediaSourceType.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
