...
class ImageProviderInfo {
  ...
  bool operator ==(Object other) => identical(this, other) || other is ImageProviderInfo &&
    other.name == name &&
    _deepEquality.equals(other.supportedImages, supportedImages);
  ...
  static ImageProviderInfo? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ImageProviderInfo(
        ...
        supportedImages: ImageType.listFromJson(json[r'SupportedImages']),
      );
    }
    return null;
  }
  ...
  static Map<String, List<ImageProviderInfo>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = ImageProviderInfo.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
