...
class LiveTvOptions {
  ...
  bool operator ==(Object other) => identical(this, other) || other is LiveTvOptions &&
    ...
    _deepEquality.equals(other.tunerHosts, tunerHosts) &&
    _deepEquality.equals(other.listingProviders, listingProviders) &&
    other.prePaddingSeconds == prePaddingSeconds &&
    other.postPaddingSeconds == postPaddingSeconds &&
    _deepEquality.equals(other.mediaLocationsCreated, mediaLocationsCreated) &&
  ...
  static LiveTvOptions? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return LiveTvOptions(
        ...
        tunerHosts: TunerHostInfo.listFromJson(json[r'TunerHosts']),
        listingProviders: ListingsProviderInfo.listFromJson(json[r'ListingProviders']),
        ...
        mediaLocationsCreated: json[r'MediaLocationsCreated'] is Iterable
            ? (json[r'MediaLocationsCreated'] as Iterable).cast<String>().toList(growable: false)
            : const [],
  ...
  static Map<String, List<LiveTvOptions>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = LiveTvOptions.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
