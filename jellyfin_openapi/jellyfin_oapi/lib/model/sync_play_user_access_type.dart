...
class SyncPlayUserAccessType {
  ...
  static const unknownDefaultOpenApi = SyncPlayUserAccessType._(r'unknown_default_open_api');
  ...
  SyncPlayUserAccessType? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return SyncPlayUserAccessType.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
