...
class SendCommandType {
  ...
  static const unknownDefaultOpenApi = SendCommandType._(r'unknown_default_open_api');
  ...
  SendCommandType? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return SendCommandType.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
