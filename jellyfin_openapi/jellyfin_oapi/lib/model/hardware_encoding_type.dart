...
class HardwareEncodingType {
  ...
  static const unknownDefaultOpenApi = HardwareEncodingType._(r'unknown_default_open_api');
  ...
  HardwareEncodingType? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return HardwareEncodingType.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
