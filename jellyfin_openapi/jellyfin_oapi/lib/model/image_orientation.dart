...
class ImageOrientation {
  ...
  static const unknownDefaultOpenApi = ImageOrientation._(r'unknown_default_open_api');
  ...
  ImageOrientation? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return ImageOrientation.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
