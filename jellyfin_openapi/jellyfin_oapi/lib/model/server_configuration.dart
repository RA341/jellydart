...
class ServerConfiguration {
  ...
  bool operator ==(Object other) => identical(this, other) || other is ServerConfiguration &&
    ...
    _deepEquality.equals(other.sortReplaceCharacters, sortReplaceCharacters) &&
    _deepEquality.equals(other.sortRemoveCharacters, sortRemoveCharacters) &&
    _deepEquality.equals(other.sortRemoveWords, sortRemoveWords) &&
    ...
    _deepEquality.equals(other.metadataOptions, metadataOptions) &&
    ...
    _deepEquality.equals(other.codecsUsed, codecsUsed) &&
    _deepEquality.equals(other.pluginRepositories, pluginRepositories) &&
  ...
  static ServerConfiguration? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ServerConfiguration(
        ...
        sortReplaceCharacters: json[r'SortReplaceCharacters'] is Iterable
            ? (json[r'SortReplaceCharacters'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        sortRemoveCharacters: json[r'SortRemoveCharacters'] is Iterable
            ? (json[r'SortRemoveCharacters'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        sortRemoveWords: json[r'SortRemoveWords'] is Iterable
            ? (json[r'SortRemoveWords'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        ...
        metadataOptions: MetadataOptions.listFromJson(json[r'MetadataOptions']),
        ...
        contentTypes: NameValuePair.listFromJson(json[r'ContentTypes']),
        ...
        codecsUsed: json[r'CodecsUsed'] is Iterable
            ? (json[r'CodecsUsed'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        pluginRepositories: RepositoryInfo.listFromJson(json[r'PluginRepositories']),
        ...
        pathSubstitutions: PathSubstitution.listFromJson(json[r'PathSubstitutions']),
        ...
        corsHosts: json[r'CorsHosts'] is Iterable
            ? (json[r'CorsHosts'] as Iterable).cast<String>().toList(growable: false)
            : const [],
  ...
  static Map<String, List<ServerConfiguration>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = ServerConfiguration.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
