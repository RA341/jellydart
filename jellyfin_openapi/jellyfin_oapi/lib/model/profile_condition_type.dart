...
class ProfileConditionType {
  ...
  static const unknownDefaultOpenApi = ProfileConditionType._(r'unknown_default_open_api');
  ...
  ProfileConditionType? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return ProfileConditionType.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
