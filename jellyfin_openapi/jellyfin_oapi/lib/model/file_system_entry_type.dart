...
class FileSystemEntryType {
  ...
  static const unknownDefaultOpenApi = FileSystemEntryType._(r'unknown_default_open_api');
  ...
  FileSystemEntryType? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return FileSystemEntryType.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
