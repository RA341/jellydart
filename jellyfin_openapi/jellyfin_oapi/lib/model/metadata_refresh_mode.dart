...
class MetadataRefreshMode {
  ...
  static const unknownDefaultOpenApi = MetadataRefreshMode._(r'unknown_default_open_api');
  ...
  MetadataRefreshMode? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return MetadataRefreshMode.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
