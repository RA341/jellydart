...
class LiveTvServiceStatus {
  ...
  static const unknownDefaultOpenApi = LiveTvServiceStatus._(r'unknown_default_open_api');
  ...
  LiveTvServiceStatus? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return LiveTvServiceStatus.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
