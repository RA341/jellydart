...
class TaskCompletionStatus {
  ...
  static const unknownDefaultOpenApi = TaskCompletionStatus._(r'unknown_default_open_api');
  ...
  TaskCompletionStatus? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return TaskCompletionStatus.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
