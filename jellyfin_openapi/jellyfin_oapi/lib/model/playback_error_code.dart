...
class PlaybackErrorCode {
  ...
  static const unknownDefaultOpenApi = PlaybackErrorCode._(r'unknown_default_open_api');
  ...
  PlaybackErrorCode? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return PlaybackErrorCode.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
