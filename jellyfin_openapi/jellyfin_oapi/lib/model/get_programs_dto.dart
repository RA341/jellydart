...
class GetProgramsDto {
  ...
  bool operator ==(Object other) => identical(this, other) || other is GetProgramsDto &&
    _deepEquality.equals(other.channelIds, channelIds) &&
    other.userId == userId &&
  ...
  static GetProgramsDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return GetProgramsDto(
        channelIds: json[r'ChannelIds'] is Iterable
            ? (json[r'ChannelIds'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        userId: mapValueOfType<String>(json, r'UserId'),
        minStartDate: mapDateTime(json, r'MinStartDate', r''),
        hasAired: mapValueOfType<bool>(json, r'HasAired'),
        isAiring: mapValueOfType<bool>(json, r'IsAiring'),
        maxStartDate: mapDateTime(json, r'MaxStartDate', r''),
        minEndDate: mapDateTime(json, r'MinEndDate', r''),
        maxEndDate: mapDateTime(json, r'MaxEndDate', r''),
        ...
        sortBy: json[r'SortBy'] is Iterable
            ...
            : const [],
        sortOrder: SortOrder.listFromJson(json[r'SortOrder']),
        genres: json[r'Genres'] is Iterable
            ? (json[r'Genres'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        genreIds: json[r'GenreIds'] is Iterable
            ? (json[r'GenreIds'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        ...
        enableImageTypes: ImageType.listFromJson(json[r'EnableImageTypes']),
        ...
        fields: ItemFields.listFromJson(json[r'Fields']),
      );
    }
    return null;
  }
  ...
  static Map<String, List<GetProgramsDto>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = GetProgramsDto.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
