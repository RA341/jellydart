...
class GroupQueueMode {
  ...
  static const unknownDefaultOpenApi = GroupQueueMode._(r'unknown_default_open_api');
  ...
  GroupQueueMode? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return GroupQueueMode.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
