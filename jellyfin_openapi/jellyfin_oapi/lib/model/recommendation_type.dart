...
class RecommendationType {
  ...
  static const unknownDefaultOpenApi = RecommendationType._(r'unknown_default_open_api');
  ...
  RecommendationType? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return RecommendationType.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
