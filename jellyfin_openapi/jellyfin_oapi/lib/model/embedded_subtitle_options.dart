...
class EmbeddedSubtitleOptions {
  ...
  static const unknownDefaultOpenApi = EmbeddedSubtitleOptions._(r'unknown_default_open_api');
  ...
  EmbeddedSubtitleOptions? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return EmbeddedSubtitleOptions.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
