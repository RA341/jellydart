...
class NotificationLevel {
  ...
  static const unknownDefaultOpenApi = NotificationLevel._(r'unknown_default_open_api');
  ...
  NotificationLevel? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return NotificationLevel.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
