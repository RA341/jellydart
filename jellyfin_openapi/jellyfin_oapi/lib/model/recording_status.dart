...
class RecordingStatus {
  ...
  static const unknownDefaultOpenApi = RecordingStatus._(r'unknown_default_open_api');
  ...
  RecordingStatus? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return RecordingStatus.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
