...
class EncodingContext {
  ...
  static const unknownDefaultOpenApi = EncodingContext._(r'unknown_default_open_api');
  ...
  EncodingContext? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return EncodingContext.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
