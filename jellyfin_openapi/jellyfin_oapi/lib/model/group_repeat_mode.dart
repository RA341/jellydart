...
class GroupRepeatMode {
  ...
  static const unknownDefaultOpenApi = GroupRepeatMode._(r'unknown_default_open_api');
  ...
  GroupRepeatMode? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return GroupRepeatMode.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
