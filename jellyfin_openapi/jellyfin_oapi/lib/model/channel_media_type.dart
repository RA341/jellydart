...
class ChannelMediaType {
  ...
  static const unknownDefaultOpenApi = ChannelMediaType._(r'unknown_default_open_api');
  ...
  ChannelMediaType? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return ChannelMediaType.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
