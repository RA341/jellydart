...
class ProfileConditionValue {
  ...
  static const unknownDefaultOpenApi = ProfileConditionValue._(r'unknown_default_open_api');
  ...
  ProfileConditionValue? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return ProfileConditionValue.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
