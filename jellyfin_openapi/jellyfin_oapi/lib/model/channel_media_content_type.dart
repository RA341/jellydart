...
class ChannelMediaContentType {
  ...
  static const unknownDefaultOpenApi = ChannelMediaContentType._(r'unknown_default_open_api');
  ...
  ChannelMediaContentType? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return ChannelMediaContentType.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
