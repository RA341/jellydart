...
class RemoteSearchResult {
  ...
  static RemoteSearchResult? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return RemoteSearchResult(
        ...
        albumArtist: RemoteSearchResult.fromJson(json[r'AlbumArtist']),
        artists: RemoteSearchResult.listFromJson(json[r'Artists']),
      );
    }
    return null;
  }
  ...
  static Map<String, List<RemoteSearchResult>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = RemoteSearchResult.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
