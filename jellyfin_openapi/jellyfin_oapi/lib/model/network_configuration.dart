...
class NetworkConfiguration {
  ...
  bool operator ==(Object other) => identical(this, other) || other is NetworkConfiguration &&
    ...
    _deepEquality.equals(other.publishedServerUriBySubnet, publishedServerUriBySubnet) &&
    other.autoDiscoveryTracing == autoDiscoveryTracing &&
    other.autoDiscovery == autoDiscovery &&
    _deepEquality.equals(other.remoteIPFilter, remoteIPFilter) &&
    ...
    _deepEquality.equals(other.localNetworkSubnets, localNetworkSubnets) &&
    _deepEquality.equals(other.localNetworkAddresses, localNetworkAddresses) &&
    _deepEquality.equals(other.knownProxies, knownProxies) &&
  ...
  static NetworkConfiguration? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return NetworkConfiguration(
        ...
        publishedServerUriBySubnet: json[r'PublishedServerUriBySubnet'] is Iterable
            ? (json[r'PublishedServerUriBySubnet'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        ...
        remoteIPFilter: json[r'RemoteIPFilter'] is Iterable
            ? (json[r'RemoteIPFilter'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        ...
        localNetworkSubnets: json[r'LocalNetworkSubnets'] is Iterable
            ? (json[r'LocalNetworkSubnets'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        localNetworkAddresses: json[r'LocalNetworkAddresses'] is Iterable
            ? (json[r'LocalNetworkAddresses'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        knownProxies: json[r'KnownProxies'] is Iterable
            ? (json[r'KnownProxies'] as Iterable).cast<String>().toList(growable: false)
            : const [],
  ...
  static Map<String, List<NetworkConfiguration>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = NetworkConfiguration.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
