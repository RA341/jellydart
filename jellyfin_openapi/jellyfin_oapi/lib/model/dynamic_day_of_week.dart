...
class DynamicDayOfWeek {
  ...
  static const unknownDefaultOpenApi = DynamicDayOfWeek._(r'unknown_default_open_api');
  ...
  DynamicDayOfWeek? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return DynamicDayOfWeek.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
