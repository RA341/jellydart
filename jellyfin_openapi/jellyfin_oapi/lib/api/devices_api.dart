...
class DevicesApi {
  ...
  ///   Device Id.
  ///
  /// * [DeviceOptionsDto] deviceOptionsDto (required):
  ///   Device Options.
  Future<Response> updateDeviceOptionsWithHttpInfo(String id, DeviceOptionsDto deviceOptionsDto,) async {
    // ignore: prefer_const_declarations
    final path = r'/Devices/Options';
  ...
  /// * [DeviceOptionsDto] deviceOptionsDto (required):
  ///   Device Options.
  Future<void> updateDeviceOptions(String id, DeviceOptionsDto deviceOptionsDto,) async {
    final response = await updateDeviceOptionsWithHttpInfo(id, deviceOptionsDto,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
