...
class DlnaApi {
  ...
  ///   Device profile.
  Future<Response> createProfileWithHttpInfo({ DeviceProfile? deviceProfile, }) async {
  ...
  /// * [DeviceProfile] deviceProfile:
  ///   Device profile.
  Future<void> createProfile({ DeviceProfile? deviceProfile, }) async {
    final response = await createProfileWithHttpInfo( deviceProfile: deviceProfile, );
  ...
  /// * [DeviceProfile] deviceProfile:
  ///   Device profile.
  Future<Response> updateProfileWithHttpInfo(String profileId, { DeviceProfile? deviceProfile, }) async {
    // ignore: prefer_const_declarations
    final path = r'/Dlna/Profiles/{profileId}'
      .replaceAll('{profileId}', profileId);
  ...
  /// * [DeviceProfile] deviceProfile:
  ///   Device profile.
  Future<void> updateProfile(String profileId, { DeviceProfile? deviceProfile, }) async {
    final response = await updateProfileWithHttpInfo(profileId,  deviceProfile: deviceProfile, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
