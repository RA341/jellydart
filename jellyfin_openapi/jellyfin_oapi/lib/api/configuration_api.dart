...
class ConfigurationApi {
  ...
  /// Parameters:
  ///
  /// * [ServerConfiguration] serverConfiguration (required):
  ///   Configuration.
  Future<Response> updateConfigurationWithHttpInfo(ServerConfiguration serverConfiguration,) async {
    // ignore: prefer_const_declarations
    final path = r'/System/Configuration';
  ...
  /// * [ServerConfiguration] serverConfiguration (required):
  ///   Configuration.
  Future<void> updateConfiguration(ServerConfiguration serverConfiguration,) async {
    final response = await updateConfigurationWithHttpInfo(serverConfiguration,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  /// Parameters:
  ///
  /// * [MediaEncoderPathDto] mediaEncoderPathDto (required):
  ///   Media encoder path form body.
  Future<Response> updateMediaEncoderPathWithHttpInfo(MediaEncoderPathDto mediaEncoderPathDto,) async {
    // ignore: prefer_const_declarations
  ...
  /// * [MediaEncoderPathDto] mediaEncoderPathDto (required):
  ///   Media encoder path form body.
  Future<void> updateMediaEncoderPath(MediaEncoderPathDto mediaEncoderPathDto,) async {
    final response = await updateMediaEncoderPathWithHttpInfo(mediaEncoderPathDto,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
