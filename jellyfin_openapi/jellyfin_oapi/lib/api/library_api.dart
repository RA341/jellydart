...
class LibraryApi {
  ...
  /// Parameters:
  ///
  /// * [MediaUpdateInfoDto] mediaUpdateInfoDto (required):
  ///   The update paths.
  Future<Response> postUpdatedMediaWithHttpInfo(MediaUpdateInfoDto mediaUpdateInfoDto,) async {
    // ignore: prefer_const_declarations
  ...
  /// * [MediaUpdateInfoDto] mediaUpdateInfoDto (required):
  ///   The update paths.
  Future<void> postUpdatedMedia(MediaUpdateInfoDto mediaUpdateInfoDto,) async {
    final response = await postUpdatedMediaWithHttpInfo(mediaUpdateInfoDto,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
