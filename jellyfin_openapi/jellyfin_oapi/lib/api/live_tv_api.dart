...
class LiveTvApi {
  ...
  ///   New listings info.
  Future<Response> addListingProviderWithHttpInfo({ String? pw, bool? validateListings, bool? validateLogin, ListingsProviderInfo? listingsProviderInfo, }) async {
  ...
  Future<ListingsProviderInfo?> addListingProvider({ String? pw, bool? validateListings, bool? validateLogin, ListingsProviderInfo? listingsProviderInfo, }) async {
    final response = await addListingProviderWithHttpInfo( pw: pw, validateListings: validateListings, validateLogin: validateLogin, listingsProviderInfo: listingsProviderInfo, );
  ...
  ///   New tuner host.
  Future<Response> addTunerHostWithHttpInfo({ TunerHostInfo? tunerHostInfo, }) async {
    // ignore: prefer_const_declarations
  ...
  Future<TunerHostInfo?> addTunerHost({ TunerHostInfo? tunerHostInfo, }) async {
    final response = await addTunerHostWithHttpInfo( tunerHostInfo: tunerHostInfo, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> createSeriesTimerWithHttpInfo({ SeriesTimerInfoDto? seriesTimerInfoDto, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [SeriesTimerInfoDto] seriesTimerInfoDto:
  ///   New series timer info.
  Future<void> createSeriesTimer({ SeriesTimerInfoDto? seriesTimerInfoDto, }) async {
    final response = await createSeriesTimerWithHttpInfo( seriesTimerInfoDto: seriesTimerInfoDto, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  ///   New timer info.
  Future<Response> createTimerWithHttpInfo({ TimerInfoDto? timerInfoDto, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [TimerInfoDto] timerInfoDto:
  ///   New timer info.
  Future<void> createTimer({ TimerInfoDto? timerInfoDto, }) async {
    final response = await createTimerWithHttpInfo( timerInfoDto: timerInfoDto, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  ///   Request body.
  Future<Response> getProgramsWithHttpInfo({ GetProgramsDto? getProgramsDto, }) async {
    // ignore: prefer_const_declarations
    final path = r'/LiveTv/Programs';
  ...
  Future<BaseItemDtoQueryResult?> getPrograms({ GetProgramsDto? getProgramsDto, }) async {
    final response = await getProgramsWithHttpInfo( getProgramsDto: getProgramsDto, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// Parameters:
  ///
  /// * [SetChannelMappingDto] setChannelMappingDto (required):
  ///   The set channel mapping dto.
  Future<Response> setChannelMappingWithHttpInfo(SetChannelMappingDto setChannelMappingDto,) async {
    // ignore: prefer_const_declarations
  ...
  Future<TunerChannelMapping?> setChannelMapping(SetChannelMappingDto setChannelMappingDto,) async {
    final response = await setChannelMappingWithHttpInfo(setChannelMappingDto,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [SeriesTimerInfoDto] seriesTimerInfoDto:
  ///   New series timer info.
  Future<Response> updateSeriesTimerWithHttpInfo(String timerId, { SeriesTimerInfoDto? seriesTimerInfoDto, }) async {
    // ignore: prefer_const_declarations
    final path = r'/LiveTv/SeriesTimers/{timerId}'
      .replaceAll('{timerId}', timerId);
  ...
  /// * [SeriesTimerInfoDto] seriesTimerInfoDto:
  ///   New series timer info.
  Future<void> updateSeriesTimer(String timerId, { SeriesTimerInfoDto? seriesTimerInfoDto, }) async {
    final response = await updateSeriesTimerWithHttpInfo(timerId,  seriesTimerInfoDto: seriesTimerInfoDto, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  /// * [TimerInfoDto] timerInfoDto:
  ///   New timer info.
  Future<Response> updateTimerWithHttpInfo(String timerId, { TimerInfoDto? timerInfoDto, }) async {
    // ignore: prefer_const_declarations
    final path = r'/LiveTv/Timers/{timerId}'
      .replaceAll('{timerId}', timerId);
  ...
  /// * [TimerInfoDto] timerInfoDto:
  ///   New timer info.
  Future<void> updateTimer(String timerId, { TimerInfoDto? timerInfoDto, }) async {
    final response = await updateTimerWithHttpInfo(timerId,  timerInfoDto: timerInfoDto, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
