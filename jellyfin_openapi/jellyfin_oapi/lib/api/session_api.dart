...
class SessionApi {
  ...
  /// Parameters:
  ///
  /// * [ClientCapabilitiesDto] clientCapabilitiesDto (required):
  ///   The MediaBrowser.Model.Session.ClientCapabilities.
  ///
  /// * [String] id:
  ///   The session id.
  Future<Response> postFullCapabilitiesWithHttpInfo(ClientCapabilitiesDto clientCapabilitiesDto, { String? id, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [String] id:
  ///   The session id.
  Future<void> postFullCapabilities(ClientCapabilitiesDto clientCapabilitiesDto, { String? id, }) async {
    final response = await postFullCapabilitiesWithHttpInfo(clientCapabilitiesDto,  id: id, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  ///   The session id.
  ///
  /// * [GeneralCommand] generalCommand (required):
  ///   The MediaBrowser.Model.Session.GeneralCommand.
  Future<Response> sendFullGeneralCommandWithHttpInfo(String sessionId, GeneralCommand generalCommand,) async {
    // ignore: prefer_const_declarations
  ...
  /// * [GeneralCommand] generalCommand (required):
  ///   The MediaBrowser.Model.Session.GeneralCommand.
  Future<void> sendFullGeneralCommand(String sessionId, GeneralCommand generalCommand,) async {
    final response = await sendFullGeneralCommandWithHttpInfo(sessionId, generalCommand,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  ///   The session id.
  ///
  /// * [MessageCommand] messageCommand (required):
  ///   The MediaBrowser.Model.Session.MessageCommand object containing Header, Message Text, and TimeoutMs.
  Future<Response> sendMessageCommandWithHttpInfo(String sessionId, MessageCommand messageCommand,) async {
    // ignore: prefer_const_declarations
  ...
  /// * [MessageCommand] messageCommand (required):
  ///   The MediaBrowser.Model.Session.MessageCommand object containing Header, Message Text, and TimeoutMs.
  Future<void> sendMessageCommand(String sessionId, MessageCommand messageCommand,) async {
    final response = await sendMessageCommandWithHttpInfo(sessionId, messageCommand,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
