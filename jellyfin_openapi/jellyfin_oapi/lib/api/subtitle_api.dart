...
class SubtitleApi {
  ...
  ///
  /// * [UploadSubtitleDto] uploadSubtitleDto (required):
  ///   The request body.
  Future<Response> uploadSubtitleWithHttpInfo(String itemId, UploadSubtitleDto uploadSubtitleDto,) async {
    // ignore: prefer_const_declarations
  ...
  /// * [UploadSubtitleDto] uploadSubtitleDto (required):
  ///   The request body.
  Future<void> uploadSubtitle(String itemId, UploadSubtitleDto uploadSubtitleDto,) async {
    final response = await uploadSubtitleWithHttpInfo(itemId, uploadSubtitleDto,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
