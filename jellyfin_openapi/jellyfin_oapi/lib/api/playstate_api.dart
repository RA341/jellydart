...
class PlaystateApi {
  ...
  Future<Response> reportPlaybackProgressWithHttpInfo({ PlaybackProgressInfo? playbackProgressInfo, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [PlaybackProgressInfo] playbackProgressInfo:
  ///   The playback progress info.
  Future<void> reportPlaybackProgress({ PlaybackProgressInfo? playbackProgressInfo, }) async {
    final response = await reportPlaybackProgressWithHttpInfo( playbackProgressInfo: playbackProgressInfo, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  Future<Response> reportPlaybackStartWithHttpInfo({ PlaybackStartInfo? playbackStartInfo, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [PlaybackStartInfo] playbackStartInfo:
  ///   The playback start info.
  Future<void> reportPlaybackStart({ PlaybackStartInfo? playbackStartInfo, }) async {
    final response = await reportPlaybackStartWithHttpInfo( playbackStartInfo: playbackStartInfo, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  Future<Response> reportPlaybackStoppedWithHttpInfo({ PlaybackStopInfo? playbackStopInfo, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [PlaybackStopInfo] playbackStopInfo:
  ///   The playback stop info.
  Future<void> reportPlaybackStopped({ PlaybackStopInfo? playbackStopInfo, }) async {
    final response = await reportPlaybackStoppedWithHttpInfo( playbackStopInfo: playbackStopInfo, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
