...
class DisplayPreferencesApi {
  ...
  ///   Client.
  ///
  /// * [DisplayPreferencesDto] displayPreferencesDto (required):
  ///   New Display Preferences object.
  Future<Response> updateDisplayPreferencesWithHttpInfo(String displayPreferencesId, String userId, String client, DisplayPreferencesDto displayPreferencesDto,) async {
    // ignore: prefer_const_declarations
    final path = r'/DisplayPreferences/{displayPreferencesId}'
      .replaceAll('{displayPreferencesId}', displayPreferencesId);
  ...
  /// * [DisplayPreferencesDto] displayPreferencesDto (required):
  ///   New Display Preferences object.
  Future<void> updateDisplayPreferences(String displayPreferencesId, String userId, String client, DisplayPreferencesDto displayPreferencesDto,) async {
    final response = await updateDisplayPreferencesWithHttpInfo(displayPreferencesId, userId, client, displayPreferencesDto,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
