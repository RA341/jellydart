...
class EnvironmentApi {
  ...
  /// Parameters:
  ///
  /// * [ValidatePathDto] validatePathDto (required):
  ///   Validate request object.
  Future<Response> validatePathWithHttpInfo(ValidatePathDto validatePathDto,) async {
    // ignore: prefer_const_declarations
  ...
  /// * [ValidatePathDto] validatePathDto (required):
  ///   Validate request object.
  Future<void> validatePath(ValidatePathDto validatePathDto,) async {
    final response = await validatePathWithHttpInfo(validatePathDto,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
