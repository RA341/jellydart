...
class PlaylistsApi {
  ...
  Future<Response> createPlaylistWithHttpInfo({ String? name, List<String>? ids, String? userId, String? mediaType, CreatePlaylistDto? createPlaylistDto, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [CreatePlaylistDto] createPlaylistDto:
  ///   The create playlist payload.
  Future<PlaylistCreationResult?> createPlaylist({ String? name, List<String>? ids, String? userId, String? mediaType, CreatePlaylistDto? createPlaylistDto, }) async {
    final response = await createPlaylistWithHttpInfo( name: name, ids: ids, userId: userId, mediaType: mediaType, createPlaylistDto: createPlaylistDto, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
