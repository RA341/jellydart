...
class NotificationsApi {
  ...
  /// Parameters:
  ///
  /// * [AdminNotificationDto] adminNotificationDto (required):
  ///   The notification request.
  Future<Response> createAdminNotificationWithHttpInfo(AdminNotificationDto adminNotificationDto,) async {
  ...
  /// * [AdminNotificationDto] adminNotificationDto (required):
  ///   The notification request.
  Future<void> createAdminNotification(AdminNotificationDto adminNotificationDto,) async {
    final response = await createAdminNotificationWithHttpInfo(adminNotificationDto,);
